...
public class CreateProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG, "selected service type list is " + selectedServiceTypeList);
    ...
    private void init() {
        ...
        serviceTypeAdapter = new ServiceTypeAdapter(CreateProfileActivity.this, serviceTypeArrayList);
    ...
    private void getAllServiceTypes() {
        Log.i(TAG, "In getAllServiceTypes");
